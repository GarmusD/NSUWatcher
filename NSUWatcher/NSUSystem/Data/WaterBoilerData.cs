...
namespace NSUWatcher.NSUSystem.Data
{
    public class WaterBoilerDataContract : IWaterBoilerDataContract
    {
        ...
        public IElHeatingDataDataContract[] ElHeatingData { get; set; } = new ElHeatingDataContract[IWaterBoilerDataContract.MAX_WATERBOILER_EL_HEATING_COUNT];
        ...
        public WaterBoilerDataContract(IWaterBoilerSnapshot snapshot)
        {
            ...
            for (int i = 0; i < IWaterBoilerDataContract.MAX_WATERBOILER_EL_HEATING_COUNT; i++)
            {
